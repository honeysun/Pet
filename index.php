...
<html lang="en">
  <head>
    ...
    #slides {
  	...
  	<link href="../javascript/bounceslider/bounce_slider.css" type="text/css" rel="stylesheet" media="all" /-->
  ...
  <div class="dialog registration-dialog">
          ...
          <div class="row">
            ...
            <div class="span2">
              ...
              <ul class="bottom-links">
                <li><a href="#fakelink">Safety</a></li>
                <li><a href="#fakelink">How it works</a></li>
                <li><a href="#fakelink">Why Host</a></li>
              </ul>
            </div>
              ...
              <ul class="bottom-links">
                ...
                <li><a href="#fakelink">Policies</a></li>
                <li><a href="#fakelink">Terms and Privacy</a></li>
              </ul>
            </div>
    ...
    <script src="UI/js/jquery.ui.touch-punch.min.js"></script>
    <script src="UI/js/bootstrap.min.js"></script>
    <script src="UI/js/bootstrap-select.js"></script>
    <script src="UI/js/bootstrap-switch.js"></script>
    <script src="UI/js/flatui-checkbox.js"></script>
    <script src="UI/js/flatui-radio.js"></script>
    <script src="UI/js/jquery.tagsinput.js"></script>
